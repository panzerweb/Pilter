            ...
            @if (Route::has('login'))
                <nav class="navbar navbar-expand-md shadow-sm">
                    <div class="container-lg">
                        ...
                        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#welcomeContent" aria-controls="welcomeContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                            <span class="navbar-toggler-icon"></span>
                        </button>

                        <!-- Collapsible Content -->
                        <div class="collapse navbar-collapse" id="welcomeContent">
                            <!-- Right Side Links -->
